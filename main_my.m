...
%   noise.
%    REFERENCES: [1] 2020 [Medina et al] Compact CRB for delay, Doppler,  and phase estimation - application to GNSS SPP and RTK
%                    performance characterisation                    DOI: 10.1049/iet-rsn.2020.0168
%                [2] 2020 [Lubeigt et al] Joint Delay-Doppler Estimation Performance in a Dual Source Context
%                    DOI: 10.3390/rs12233894
%                [3] 2023 [Lubeigt et al] Untangling first and second order  statistics contributions in multipath scenarios
%                    DOI: 10.1016/j.sigpro.2022.108868
%                [4] 2022 [Lubeigt et al] Clean-to-Composite Bound Ratio:  A New Multipath Criterion for GNSS Signal Design and 
%                    Analysis                    DOI: 10.1109/TAES.2022.3172023
% -------------------------------------------------------------------------
...
%   estimation of the time-delay, Doppler frequency and complex amplitude of a single signal embedded in an additive white Gaussian noise. It
...
% -------------------------------------------------------------------------
%   DESCRIPTION: This function compute the dual source CRB for the  estimation of the time-delay, Doppler frequency and complex amplitude
%   of a signal and a single reflection, embedded in an additive white Gaussian noise. It implements the expressions derived in [2].
% -------------------------------------------------------------------------
            global considered_signal 
            global fs fc Fc
            global lampColor
...
% -------------------------------------------------------------------------
%   DESCRIPTION: This function compute the misspecified CRB for the estimation of the time-delay, Doppler frequency and complex amplitude
%   of a signal in presence of a single multipath, embedded in an additive white Gaussian noise. It implements the expressions derived in [3].
% -------------------------------------------------------------------------
            global considered_signal 
            global fs fc Fc F0 Tcode
            global lampColor
...
% -------------------------------------------------------------------------
%   DESCRIPTION: This function compute the Clean-to-Composite Bound Ratio for the estimation of the time-delay, Doppler frequency and complex 
%   amplitude of a signal in presence of a single multipath, embedded in an additive white Gaussian noise. It implements the expressions derived in
%   [4].
% -------------------------------------------------------------------------
            global considered_signal 
            global fs fc Fc
